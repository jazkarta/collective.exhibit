...
def setup_product():
    ...
    zcml.load_config('configure.zcml', collective.exhibit)
    ...
    ztc.installPackage('collective.exhibit')
...
setup_product()
ptc.setupPloneSite(products=['collective.exhibit'])
...
class FunctionalTestCase(ptc.FunctionalTestCase):
    ...
    def afterSetUp(self):
        ...
        importer_roles = ('Contributor','FMProImport')
        self.portal.portal_membership.addMember('contributor',
                                                'secret',
                                                roles, [])
        self.portal.portal_membership.addMember('importer',
                                                'secret',
                                                importer_roles, [])
